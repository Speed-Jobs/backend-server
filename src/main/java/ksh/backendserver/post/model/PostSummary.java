...
public class PostSummary {
    ...
    public static PostSummary from(PostWithCompanyAndRole projection, LocalDate now) {
        return new PostSummary(projection, now);
    }

    private PostSummary(PostWithCompanyAndRole projection, LocalDate now) {
