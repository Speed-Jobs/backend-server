...
public class NotificationService {
    ...
    public void sendNotifications(Map<UserSubscription, List<PostSkillRequirement>> alertMap) {
        alertMap.forEach((subscription, matchedPosts) ->
            sendNotificationsToUser(subscription.getUserId(), matchedPosts)
        );
    }

    private void sendNotificationsToUser(Long memberId, List<PostSkillRequirement> matchedPosts) {
